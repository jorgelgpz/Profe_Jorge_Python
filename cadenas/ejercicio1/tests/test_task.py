...
class PruebaOperaciones(unittest.TestCase):
    def test_resultado(self):
        entrada_esperada = "Batman\n3\n"
        salida_esperada = """¿Cómo te llamas?Introduce un número entero:Batman\nBatman\nBatman\n\n"""
        ...
        with patch('sys.stdout', new=StringIO()) as salida_mock:
            ...
            with patch('sys.stdin', new=StringIO(entrada_esperada)):
                ...
                import cadenas.ejercicio1.task
    ...
    def test_resultado(self):
        entrada_esperada = "Joker\n4\n"
        salida_esperada = """¿Cómo te llamas?Introduce un número entero:Joker\nJoker\nJoker\nJoker\n\n"""
