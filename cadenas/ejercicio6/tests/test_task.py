...
class PruebaOperaciones(unittest.TestCase):
    def test_resultado(self):
        entrada_esperada = "Aprende a programar con Python\na\n"
        salida_esperada = """Introduce una frase:Introduce una vocal en minúscula:Aprende A progrAmAr con Python\n"""
        ...
        with patch('sys.stdout', new=StringIO()) as salida_mock:
            ...
            with patch('sys.stdin', new=StringIO(entrada_esperada)):
                ...
                import cadenas.ejercicio6.task
