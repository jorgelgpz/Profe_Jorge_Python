...
class PruebaOperaciones(unittest.TestCase):
    def test_resultado(self):
        entrada_esperada = "jorge@gmail.com\n"
        salida_esperada = """Introduce tu correo electrónico:jorge@mep.go.cr\n"""
        ...
        with patch('sys.stdout', new=StringIO()) as salida_mock:
            ...
            with patch('sys.stdin', new=StringIO(entrada_esperada)):
                ...
                import cadenas.ejercicio7.task
    ...
    def test_resultado(self):
        entrada_esperada = "estudiante@gmail.com\n"
        salida_esperada = """Introduce tu correo electrónico:estudiante@mep.go.cr\n"""
