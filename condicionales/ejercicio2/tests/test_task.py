...
class PruebaOperaciones(unittest.TestCase):
    def test_resultado(self):
        entrada_esperada = "contraseña\n"
        salida_esperada = """Introduce la contraseña:La contraseña coincide\n"""
        ...
        with patch('sys.stdout', new=StringIO()) as salida_mock:
            ...
            with patch('sys.stdin', new=StringIO(entrada_esperada)):
                ...
                import condicionales.ejercicio2.task
    ...
    def test_resultado(self):
        entrada_esperada = "kontraseña\n"
        salida_esperada = """Introduce la contraseña:La contraseña no coincide\n"""
