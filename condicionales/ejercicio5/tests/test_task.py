...
class PruebaOperaciones(unittest.TestCase):
    def test_resultado(self):
        entrada_esperada = "17\n1000\n"
        salida_esperada = """¿Cuál es tu edad?¿Cuales son tus ingresos mensuales?Tienes que cotizar\n"""
        ...
        with patch('sys.stdout', new=StringIO()) as salida_mock:
            ...
            with patch('sys.stdin', new=StringIO(entrada_esperada)):
                ...
                import condicionales.ejercicio5.task
    ...
    def test_resultado(self):
        entrada_esperada = "16\n1000\n"
        salida_esperada = """¿Cuál es tu edad?¿Cuales son tus ingresos mensuales?No tienes que cotizar\n"""
