...
class PruebaOperaciones(unittest.TestCase):
    def test_resultado(self):
        entrada_esperada = "Alf\nH\n"
        salida_esperada = """¿Cómo te llamas?¿Cuál es tu sexo (M o H)?Tu grupo es B\n"""
        ...
        with patch('sys.stdout', new=StringIO()) as salida_mock:
            ...
            with patch('sys.stdin', new=StringIO(entrada_esperada)):
                ...
                import condicionales.ejercicio6.task
    ...
    def test_resultado(self):
        entrada_esperada = "Carmen\nM\n"
        salida_esperada = """¿Cómo te llamas?¿Cuál es tu sexo (M o H)?Tu grupo es A\n"""
