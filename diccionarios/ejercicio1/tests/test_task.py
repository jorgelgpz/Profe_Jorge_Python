...
class PruebaOperaciones(unittest.TestCase):
    def test_resultado(self):
        entrada_esperada = "Euro\n"
        salida_esperada = """Introduce una divisa:€\n"""
        ...
        with patch('sys.stdout', new=StringIO()) as salida_mock:
            ...
            with patch('sys.stdin', new=StringIO(entrada_esperada)):
                ...
                import diccionarios.ejercicio1.task
    ...
    def test_resultado(self):
        entrada_esperada = "Colon\n"
        salida_esperada = """Introduce una divisa:La divisa no está.\n"""
