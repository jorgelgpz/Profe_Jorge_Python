...
class PruebaOperaciones(unittest.TestCase):
    def test_resultado(self):
        entrada_esperada = "23/10/2018\n"
        salida_esperada = """Introduce una fecha en formato dd/mm/aaaa:23 de octubre de 2018\n"""
        ...
        with patch('sys.stdout', new=StringIO()) as salida_mock:
            ...
            with patch('sys.stdin', new=StringIO(entrada_esperada)):
                ...
                import diccionarios.ejercicio4.task
    ...
    def test_resultado(self):
        entrada_esperada = "24/08/2023\n"
        salida_esperada = """Introduce una fecha en formato dd/mm/aaaa:24 de agosto de 2023\n"""
