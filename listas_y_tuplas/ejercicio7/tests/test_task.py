...
class PruebaOperaciones(unittest.TestCase):
    def test_resultado(self):
        entrada_esperada = "ada\n"
        salida_esperada = """Introduce una palabra:Es un palíndromo\n"""
        ...
        with patch('sys.stdout', new=StringIO()) as salida_mock:
            ...
            with patch('sys.stdin', new=StringIO(entrada_esperada)):
                ...
                import listas_y_tuplas.ejercicio7.task
    ...
    def test_resultado(self):
        ...
        salida_esperada = """Introduce una palabra:No es un palíndromo\n"""
