...
class PruebaOperaciones(unittest.TestCase):
    def test_resultado(self):
        entrada_esperada = "10\n10\n"
        salida_esperada = "Introduce tus horas de trabajo:Introduce lo que cobras por hora:Tu paga es 100.0\n"
        ...
        with patch('sys.stdout', new=StringIO()) as salida_mock:
            ...
            with patch('sys.stdin', new=StringIO(entrada_esperada)):
                ...
                import tipos_de_datos_simples.ejercicio5.task
    ...
    def test_resultado(self):
        entrada_esperada = "20\n10\n"
        salida_esperada = "Introduce tus horas de trabajo:Introduce lo que cobras por hora:Tu paga es 200.0\n"
