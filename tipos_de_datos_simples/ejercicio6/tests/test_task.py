...
class PruebaOperaciones(unittest.TestCase):
    def test_resultado(self):
        entrada_esperada = "3\n"
        salida_esperada = "Introduce un número entero:La suma de los primeros números enteros desde 1 hasta 3 es 6.0\n"
        ...
        with patch('sys.stdout', new=StringIO()) as salida_mock:
            ...
            with patch('sys.stdin', new=StringIO(entrada_esperada)):
                ...
                import tipos_de_datos_simples.ejercicio6.task
    ...
    def test_resultado(self):
        entrada_esperada = "5\n"
        salida_esperada = "Introduce un número entero:La suma de los primeros números enteros desde 1 hasta 5 es 15.0\n"
